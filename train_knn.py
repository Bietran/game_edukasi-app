...
# Load gambar organik
for img_file in os.listdir("dataset/organik"):
    path = os.path.join("dataset/organik", img_file)
...
for img_file in os.listdir("dataset/anorganik"):
    path = os.path.join("dataset/anorganik", img_file)
    color = extract_avg_color(path)
    if color is not None:
        X_train.append(color)
